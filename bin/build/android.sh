...
##
## Outputs:
##   - build/dist/solitaire_<version>_android_aar.zip
##   - build/dist/solitaire_<version>_android_apk.zip
...
rm -rf ./app/libs
mkdir -p ./app/libs
cp ../mobile_android_arm64/solitaire.aar ./app/libs/
cp ../mobile_android_arm64/solitaire-sources.jar ./app/libs/

gradle assembleDebug
cd app/build/outputs/apk/debug
zip -r "$dir/../../build/dist/solitaire_${TGT}_android_apk.zip" .

echo "Output written to [./build/dist/solitaire_${TGT}_android_aar.zip] and [./build/dist/solitaire_${TGT}_android_apk.zip]"
