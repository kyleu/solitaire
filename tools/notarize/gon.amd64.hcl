...
notarize {
  path = "./build/dist/solitaire_0.1.7_darwin_amd64_desktop.dmg"
  bundle_id = "dev.kyleu.solitaire"
}
...
dmg {
  output_path = "./build/dist/solitaire_0.1.7_darwin_amd64.dmg"
  volume_name = "Solitaire"
}

zip {
  output_path = "./build/dist/solitaire_0.1.7_darwin_amd64_notarized.zip"
}
