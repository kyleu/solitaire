...
notarize {
  path = "./build/dist/solitaire_0.0.3_darwin_all_desktop.dmg"
  bundle_id = "dev.kyleu.solitaire"
}
...
dmg {
  output_path = "./build/dist/solitaire_0.0.3_darwin_all.dmg"
  volume_name = "Solitaire"
}

zip {
  output_path = "./build/dist/solitaire_0.0.3_darwin_all_notarized.zip"
}
