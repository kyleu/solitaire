...
notarize {
  path = "./build/dist/solitaire_0.0.7_darwin_arm64_desktop.dmg"
  bundle_id = "dev.kyleu.solitaire"
}
...
dmg {
  output_path = "./build/dist/solitaire_0.0.7_darwin_arm64.dmg"
  volume_name = "Solitaire"
}

zip {
  output_path = "./build/dist/solitaire_0.0.7_darwin_arm64_notarized.zip"
}
