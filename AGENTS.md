...
This file provides guidance for AI agents and humans working with the Solitaire codebase.
...
- `/app/lib/`: Mostly logic provided by github.com/kyleu/solitaire
...
The project definition lives in `.projectforge/project.json`, which represents the [github.com/kyleu/solitaire(httpsgithub.com/kyleu/solitairev) configuration.
